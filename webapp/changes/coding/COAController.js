...
*@viewId:i2d.qm.inspusgdsc.manages1::sap.suite.ui.generic.template.ObjectPage.view.Details::C_InspUsgDescMng
*/
sap.ui.define([
	...
	function (
		...
		"use strict";
		return ControllerExtension.extend("customer.ext.humanagedecision.COAController", {
			// metadata: {
			...
			// 	 * @memberOf customer.ext.humanagedecision.COAController
			// 	 */
			// 	onInit: function() {
			// 	},
