...
*@viewId:i2d.qm.inspusgdsc.manages1::sap.suite.ui.generic.template.ListReport.view.ListReport::C_InspUsgDescMng
*/
sap.ui.define([
	...
	function (
		...
		return ControllerExtension.extend("customer.ext.humanagedecision.ButtonController", {

			onManage:function(oEvt){
				debugger;
				// this.intorder = oEvt.getSource().getText();
				//i2d.qm.inspusgdsc.manages1::sap.suite.ui.generic.template.ListReport.view.ListReport::C_InspUsgDescMng--responsiveTable
				// var oSelectedIndices = this.oView.byId("sap.suite.ui.generic.template.ListReport.view.ListReport").getSelectedIndices();
				// this.selObj = this.oView.byId("sap.suite.ui.generic.template.ListReport.view.ListReport").getContextByIndex(oSelectedIndices[0]).getObject();
				var InspectionLot = this.getView().byId("i2d.qm.inspusgdsc.manages1::sap.suite.ui.generic.template.ListReport.view.ListReport::C_InspUsgDescMng--responsiveTable").getSelectedContexts()[0].getObject().InspectionLot
			},
			// metadata: {
			...
			// 	 * @memberOf customer.ext.humanagedecision.ButtonController
			// 	 */
				onInit: function() {
